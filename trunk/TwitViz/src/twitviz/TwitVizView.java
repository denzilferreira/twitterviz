...
public class TwitVizView extends FrameView {
    ...
    private void buildSocialNetwork(User user) {
        ...
        try {
            ...
            setFeedback(true, "Cannot find database file...");
            System.exit(1);
        }
        ...
        try {
            ...
            setFeedback(true, "Unable to load friend list");
        }
        ...
        try {
            ...
            setFeedback(true, "Unable to load followers list");
        }
        ...
        try{
            ...
            setFeedback(true, "Unable to save to database");
        }
        //--end save graph file
    }
    ...
    private void initComponents() {
        ...
        message_output = new javax.swing.JLabel();
        ...
        message_output.setFont(resourceMap.getFont("message_output.font")); // NOI18N
        message_output.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        message_output.setText(resourceMap.getString("message_output.text")); // NOI18N
        message_output.setName("message_output"); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(message_output, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 298, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    ...
                    .add(lbl_username)
                    .add(btn_login)
                    .add(message_output, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 33, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .add(9, 9, 9)
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            ...
            if(username.getText().length()>0 && password.getPassword().length>0) {
                ...
                if(link!=null) {
                    try {
                        ...
                        setFeedback(false,"Loaded social network");

                    } catch (TwitterException ex) {
                        setFeedback(true,"Username/Password error");
                    }
                //twitter system offline
                }else{
                    setFeedback(true,"Twitter service offline");
                }
            }
        }
}                                         

    private void setFeedback(Boolean error,String message) {
        message_output.setText(message);
        if(!error) {
            message_output.setBackground(Color.green);
            message_output.setForeground(Color.white);
        }else{
            message_output.setBackground(Color.red);
            message_output.setForeground(Color.white);
        }
        message_output.repaint();
    }
    ...
    private void keywordsTextFieldMouseClicked(java.awt.event.MouseEvent evt) {                                               
        keywordsTextField.setText("");
        keywordsTextField.setForeground(Color.BLACK);
}                                              

    private void updateTextFieldKeyTyped(java.awt.event.KeyEvent evt) {                                         
    ...
    private javax.swing.JLabel message_output;
